...
public final class Alarm implements Parcelable {
    ...
    public static class Columns implements BaseColumns {
        ...
        public static final Uri CONTENT_URI =
                Uri.parse("content://com.csst.smarthome.util.clock/alarm");
        ...
        //使用model来获取全部alarm
        public static final String WHERE_MODELID = MODELID + "=";
        
        
        static final String[] ALARM_QUERY_COLUMNS = {
            _ID, HOUR, MINUTES, DAYS_OF_WEEK, ALARM_TIME,
            ENABLED, VIBRATE, MESSAGE, ALERT, MODELID };
        ...
        public static final int ALARM_MODEL_ID = 9;
    }
    //////////////////////////////
    // End 每一列定义结替    //////////////////////////////
    ...
    public Alarm(Cursor c) {
        ...
        modelid = c.getInt(Columns.ALARM_MODEL_ID);
