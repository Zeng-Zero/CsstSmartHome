...
public class AlarmReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
    	System.out.println(TAG+" the onReceive is here \n ");
        ...
        if (km.inKeyguardRestrictedInputMode()) {
            // Use the full screen activity for security.
        	 ...
        	 System.out.println("zengqinglin here AlarmAlertFullScreen.class AlarmReceiver  \n");
...
//        System.out.println("the alarm model id "+alarm.modelid);
//        
//    	System.out.println("get the name of action is "+CsstSHModelTable.getInstance().getActionByModelId(mDb,alarm.modelid).get(0).getmActionName());
//        
    	Intent alertIntent = new Intent();
        alertIntent.setFlags(Intent.FLAG_ACTIVITY_BROUGHT_TO_FRONT | Intent.FLAG_ACTIVITY_NEW_TASK );
        alertIntent.putExtra(Alarms.ALARM_INTENT_EXTRA, alarm);
        alertIntent.setClass(context, AlarmAlertFullScreen.class);
//        alertIntent.setClass(context, SmartStartActivity.class);
        context.startActivity(alertIntent);
             
//        System.out.println("the alarm model id该公司感受感�?");
//             
//             
//        
...
//        nm.notify(alarm.id, n);
    ...
    private NotificationManager getNotificationManager(Context context) {
    	System.out.println(TAG+" the NotificationManager  getNotificationManager is here \n ");
    ...
    private void updateNotification(Context context, Alarm alarm, int timeout) {
    	System.out.println(TAG+" the updateNotification is here \n ");
        NotificationManager nm = getNotificationManager(context);
        ...
        System.out.println(TAG+" zengqinglin  viewAlarm = new Intent(context, AlarmAlertFullScreen.class)");
        Intent viewAlarm = new Intent(context, AlarmAlertFullScreen.class);
