 ...
 */
public class Alarms {
	private static String  TAG = "Alarms";

    // This action triggers the AlarmReceiver as well as the AlarmKlaxon. It
    // is a public action used in the manifest for receiving Alarm broadcasts
    // from the alarm manager.
    public static final String ALARM_ALERT_ACTION = "com.csst.smarthome.util.clock.ALARM_ALERT";
    ...
    public static final String ALARM_DONE_ACTION = "com.csst.smarthome.util.clock.ALARM_DONE";
    ...
    public static final String ALARM_SNOOZE_ACTION = "com.csst.smarthome.util.clock.ALARM_SNOOZE";

    // AlarmAlertFullScreen listens for this broadcast intent, so that other applications
    // can dismiss the alarm (after ALARM_ALERT_ACTION and before ALARM_DONE_ACTION).
    public static final String ALARM_DISMISS_ACTION = "com.csst.smarthome.util.clock.ALARM_DISMISS";
    ...
    public static long addAlarm(Context context, Alarm alarm) {
    	System.out.println(TAG+" zengqinglin  addAlarm  IN");
        ContentValues values = createContentValues(alarm);
        Uri uri = context.getContentResolver().insert(
                Alarm.Columns.CONTENT_URI, values);
        alarm.id = (int) ContentUris.parseId(uri);
        System.out.println(TAG+" zengqinglin  addAlarm  1");
        long timeInMillis = calculateAlarm(alarm);
        if (alarm.enabled) {
        	 System.out.println(TAG+" zengqinglin  addAlarm  2");
            clearSnoozeIfNeeded(context, timeInMillis);
        }
        System.out.println(TAG+" zengqinglin  addAlarm  3");
        setNextAlert(context);
        System.out.println(TAG+" zengqinglin  addAlarm  OUT");
        return timeInMillis;
    }
    ...
    private static ContentValues createContentValues(Alarm alarm) {
    	System.out.println(TAG+" zengqinglin  createContentValues  IN");
        ...
        System.out.println("Alarms "+" createContentValues the weekday is here the day is "+alarm.daysOfWeek.getCoded());
        ...
        values.put(Alarm.Columns.MODELID, alarm.modelid);
        System.out.println(TAG+" zengqinglin  createContentValues  OUT");
        return values;
    }
    ...
    private static void clearSnoozeIfNeeded(Context context, long alarmTime) {
        ...
        // enable this alarm.
    	System.out.println(TAG+" zengqinglin  clearSnoozeIfNeeded  IN");
        SharedPreferences prefs =
                context.getSharedPreferences(SmartStartActivity.PREFERENCES, 0);
        long snoozeTime = prefs.getLong(PREF_SNOOZE_TIME, 0);
        if (alarmTime < snoozeTime) {
        	System.out.println(TAG+" zengqinglin  clearSnoozeIfNeeded  clearSnoozePreference(context, prefs) ");
            clearSnoozePreference(context, prefs);
        }
        System.out.println(TAG+" zengqinglin  clearSnoozeIfNeeded  OUT");
    }
	 ...
	 * @return
	 */
	public final static List<Alarm> queryByModel(ContentResolver contentResolver, int modelid){
		
		String selection =Alarm.Columns.MODELID + "='" + modelid + "'";
		Cursor c = contentResolver.query(Alarm.Columns.CONTENT_URI,
                Alarm.Columns.ALARM_QUERY_COLUMNS, selection,
                null, null);
...
//        setStatusBarIcon(context, true);
    ...
    static void saveSnoozeAlert(final Context context, final int id,
        ...
        SharedPreferences prefs = context.getSharedPreferences(
        		SmartStartActivity.PREFERENCES, 0);
        if (id == -1) {
            clearSnoozePreference(context, prefs);
        } else {
