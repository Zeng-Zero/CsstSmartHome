...
private String TAG = "HandleSetAlarm";
    ...
    protected void onCreate(Bundle icicle) {
        ...
        if (intent == null || !ACTION_SET_ALARM.equals(intent.getAction())) {
            ...
            startActivity(new Intent(this, SmartStartActivity.class));
            finish();
            return;
        }
        ...
        try {
            ...
            if (c != null && c.moveToFirst()) {
                ...
                System.out.println(TAG+" zengqinglin  viewAlarm = SetAlarm.popAlarmSetToast(this, timeInMillis);");
//                SetAlarm.popAlarmSetToast(this, timeInMillis);
        ...
        if (getContentResolver().insert(
        	...
        	System.out.println(TAG+" zengqinglin  viewAlarm = SetAlarm.popAlarmSetToast(this, timeInMillis); 222");
//            SetAlarm.popAlarmSetToast(this, timeInMillis);
