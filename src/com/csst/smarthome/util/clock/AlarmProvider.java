...
public class AlarmProvider extends ContentProvider {
    ...
    static {
        sURLMatcher.addURI("com.csst.smarthome.util.clock", "alarm", ALARMS);
        sURLMatcher.addURI("com.csst.smarthome.util.clock", "alarm/#", ALARMS_ID);
    }
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
         ...
         String insertMe = "INSERT INTO alarms " +
                 "(hour, minutes, daysofweek, alarmtime, enabled, vibrate, message, alert,  modelid) " +
                 "VALUES ";
         db.execSQL(insertMe + "(8, 30, 31, 0, 0, 1, '', '',1);");
         db.execSQL(insertMe + "(9, 00, 96, 0, 0, 1, '', '',2);");
        }
