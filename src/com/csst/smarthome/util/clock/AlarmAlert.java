...
public class AlarmAlert extends AlarmAlertFullScreen {
    ...
    private final Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
        	System.out.println("AlarmAler"+"zengqinglin the mHandler here \n");
    ...
    private final BroadcastReceiver mScreenOffReceiver =
            new BroadcastReceiver() {
                ...
                public void onReceive(Context context, Intent intent) {
                	System.out.println("AlarmAler"+"zengqinglin the BroadcastReceiver here \n");
                    KeyguardManager km =
    ...
    protected void onCreate(Bundle icicle) {
    	...
    	System.out.println("AlarmAler"+"zengqinglin the oncreate here \n");
    ...
    private void handleScreenOff(final KeyguardManager km) {
        if (!km.inKeyguardRestrictedInputMode() && checkRetryCount()) {
        	...
        	System.out.println(" zengqinglin OPEN AlarmAlertFullScreen.class AlarmAlert \n");
