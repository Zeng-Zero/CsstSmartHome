...
import com.csst.smarthome.camera.BridgeService.PlayInterface;
import com.csst.smarthome.camera.ContentCommon;
import com.csst.smarthome.camera.CustomBuffer;
import com.csst.smarthome.camera.CustomBufferData;
import com.csst.smarthome.camera.CustomBufferHead;
...
public class PlayActivity extends Activity implements OnTouchListener,
	...
	private CsstSHCameraBean mCamera = null;
	...
	public void showSureDialog1() {
		...
		builder.setTitle(getResources().getString(R.string.exit_lable)
				+ getResources().getString(R.string.app_name));
		builder.setMessage(R.string.exit_alert);
		builder.setPositiveButton(R.string.csst_ok,
...
//				playSurface.setBackgroundDrawable(drawable);
	...
	public void initExitPopupWindow2() {
		...
		button_load.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				NativeCaller.PPPPCameraControl(mCamera.getCameraUuid(), 36, 36);
		...
		button_phone.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				NativeCaller.PPPPCameraControl(mCamera.getCameraUuid(), 37, 37);
				popupWindow_about.dismiss();
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		strName = mCamera.getCameraName();//SystemValue.deviceName;
		strDID = mCamera.getCameraUuid();//SystemValue.deviceId;
		findView();
		InitParams();
	...
	public void onClick(View v) {
		...
		case R.id.ptz_hori_mirror:
			if (isHorizontalMirror) {
				...
				Log.d("tag", "水平镜像还" + ContentCommon.CMD_PTZ_ORIGINAL);
			} else {
		...
		case R.id.ptz_hori_tour:
			if (isLeftRight) {
				...
				Log.d("tag", "水平巡视开�?" + ContentCommon.CMD_PTZ_LEFT_RIGHT);
			}
			break;
		case R.id.ptz_vert_tour:
			if (isUpDown) {
				...
				Log.d("tag", "垂直巡视开�?" + ContentCommon.CMD_PTZ_UP_DOWN);
			}
			break;
		case R.id.ptz_audio:
		...
		seekBar.setOnSeekBarChangeListener(new OnSeekBarChangeListener() {
			...
			public void onStopTrackingTouch(SeekBar seekBar) {
				...
				case BRIGHT:// 亮度
					...
					break;
				case CONTRAST:// 对比�?					nContrast = progress;
