...
import com.csst.smarthome.activity.fragment.CsstSHAddModelListActionView;
 ...
 * @author liuyang
 */
public class DeviceModify extends Activity implements ICsstSHInitialize, ICsstSHConstant{
...
//		mBtnDone.setVisibility(View.GONE);
	...
	private final void backEvent(){
		...
		intent.setClass(DeviceModify.this, SmartStartActivity.class);
//		intent.putExtra("IP", modemIp);
		startActivity(intent);
		DeviceModify.this.finish();
	}
	...
	private final class DoneBtnListener implements View.OnClickListener{
		...
		public void onClick(View v) {
			if(mETModelName.getText().toString().equals("")){
				Toast.makeText(DeviceModify.this, R.string.csst_model_name_null_tip, Toast.LENGTH_LONG).show();;
			}else{
				Intent intent = new Intent();
				intent.setClass(DeviceModify.this, CsstSHAddModelListActionView.class);
